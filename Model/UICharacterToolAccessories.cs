...
// Type: UICharacterToolAccessories
...
public class UICharacterToolAccessories : MonoBehaviour
{
  ...
  private void AddItemsToGrid()
  {
    ...
    int num = this.screen.profilesWidget.selectedGender != UICharacterToolProfiles.Gender.Male ? Portrait.accessoriesFemale.Length : Portrait.accessoriesMale.Length;
