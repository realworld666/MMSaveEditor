...
public class UICharacterToolHairStyle : MonoBehaviour
{
  ...
  private void AddItemsToGrid()
  {
    ...
    int num = this.screen.profilesWidget.selectedGender != UICharacterToolProfiles.Gender.Male ? Portrait.hairStylesFemale.Length : Portrait.hairStylesMale.Length;
